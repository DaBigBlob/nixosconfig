...
let
    ...
    fish_prompt = ''
        function fish_prompt
            ...
            set -l delim2 (set_color yellow)$decA(set_color green)$decA(set_color red)$decA(if fish_is_root_user; set_color red; else; set_color green; end)" "$USER(set_color purple)"$hostname "(set_color normal)
